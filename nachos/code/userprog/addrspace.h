...
class ProcessAddressSpace {
  public:
    ProcessAddressSpace(OpenFile *executable, char* f);	// Create an address space,
    ...
    unsigned int getNextPhysicalPage(unsigned int, bool);

    void fixPageFault(unsigned int vadd, bool swap);
